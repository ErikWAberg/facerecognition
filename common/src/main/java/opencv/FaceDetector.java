...
public class FaceDetector {
    ...
    public FaceDetector(String cascadeResourcePath) throws FileNotFoundException, URISyntaxException {
        ...
        //cvInitFont(mCvFont, CV_FONT_HERSHEY_DUPLEX, 0.4, 0.4, 0.0, 1, 4);

        memStorage = CvMemStorage.create();
    }


    public void detectAndDrawFace(Mat grayImageMat) {
        ...
        for (int i = 0; i < total; i++) {
            ...
            cvRectangle(grayImageMat.asCvMat(), cvPoint(x, y), cvPoint(x + w, y + h), CvScalar.GRAY, 1, 4, 0);
        }
