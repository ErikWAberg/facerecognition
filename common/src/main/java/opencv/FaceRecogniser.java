...
public class FaceRecogniser {
    ...
    String storagePath = "/Users/erik/storage";

    public FaceRecogniser(String trainingImagesDir) {
        //faceRecognizer = createEigenFaceRecognizer();
        faceRecognizer = createLBPHFaceRecognizer();
        //faceRecognizer = createFisherFaceRecognizer();

        String rootPath = Util.getProjectRootDir(FaceRecogniser.class);
        Log.info("Loading training-images " + trainingImagesDir + " @ " + rootPath + "\n" + rootPath + trainingImagesDir);
        File file = new File(rootPath + trainingImagesDir);
    ...
    public void save() {
        FileStorage fileStorage = new FileStorage(storagePath, FileStorage.WRITE);
        faceRecognizer.save(fileStorage);
    }

    public void load() {
        FileStorage fileStorage = new FileStorage(storagePath, FileStorage.READ);
